...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'customer_area_article', (
        ...
        db.send_create_signal(u'customer_area', ['Article'])


        # Changing field 'Comment.article'
        db.alter_column(u'customer_area_comment', 'article_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['customer_area.Article']))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'customer_area_article')


        # Changing field 'Comment.article'
        db.alter_column(u'customer_area_comment', 'article_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['customer_area.Blog']))
    ...
    models = {
        ...
        u'customer_area.comment': {
            ...
            'article': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'comment_blog'", 'null': 'True', 'to': u"orm['customer_area.Article']"}),
