...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.article'
        db.add_column(u'customer_area_comment', 'article',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='comment_blog', null=True, to=orm['customer_area.Blog']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.article'
        db.delete_column(u'customer_area_comment', 'article_id')
    ...
    models = {
        ...
        u'customer_area.comment': {
            ...
            'article': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'comment_blog'", 'null': 'True', 'to': u"orm['customer_area.Blog']"}),
